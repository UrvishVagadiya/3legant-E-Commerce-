      ...
      <div className="px-5 md:px-10 lg:px-40 py-12 md:py-18 w-full">
        <div className="flex flex-col md:flex-row justify-between mb-8 md:mb-19 text-white items-center gap-8 md:gap-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-5">
            <h3 className="text-3xl md:text-2xl font-[500]">3legant.</h3>
            <div className="hidden md:block w-[1px] h-6 bg-gray-500"></div>
            <div className="md:hidden w-8 h-[1px] bg-gray-500 mt-1 mb-2"></div>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center text-sm">
            ...
            <Link className="hover:text-gray-300 transition-all duration-300 ease-in-out" href="/contact">Contact Us</Link>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse md:flex-row text-white justify-between items-center gap-8 md:gap-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-5 md:gap-6 text-xs md:text-sm">
            ...
            <h3 className="font-[600] order-1 md:order-2 cursor-pointer hover:underline transition-all duration-300 ease-in-out">Privacy Policy</h3>
            <h3 className="font-[600] order-2 md:order-3 cursor-pointer hover:underline transition-all duration-300 ease-in-out">Terms of Use</h3>
          </div>
