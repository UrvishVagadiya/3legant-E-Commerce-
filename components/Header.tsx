...
const Header = () => {
  ...
  return (
    (isVisible && <div className='relative bg-[#F3F5F7] px-4 py-2 flex items-center justify-center w-full'>
      <div className='flex justify-center items-center gap-2 mr-6 md:mr-0'>
        <TicketPercent className="w-5 h-5 md:w-6 md:h-6" />
        <h3 className='text-sm md:text-base font-[500] text-[#141718]'>30% off storewide - Limited time!</h3>
