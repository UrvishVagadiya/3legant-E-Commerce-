...
const BlogPost = async ({
  ...
  const blog = blogsData.find((b) => b.id === parseId) || {
    id: blogId,
    img: "/article-1.png",
  ...
  return (
    <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 mb-20 mt-8 font-poppins text-[#141718]">
      ...
      <div className="max-w-[850px] w-full text-[#141718] text-[15px] md:text-[18px] leading-[1.6]">
